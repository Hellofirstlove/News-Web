    ...
    <div className="px-6 py-10 max-w-4xl mx-auto">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 leading-7">
          ...
          readers across Bangladesh and beyond. Our name reflects our
          commitment: bold, powerful, and always moving forward.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-2 leading-7">
          <li>
            <span className="font-semibold">Mission:</span> Deliver accurate,
            unbiased reporting that empowers citizens to make informed
            decisions.
          </li>
          <li>
            <span className="font-semibold">Vision:</span> Become the most
            trusted independent news platform in South Asia by 2030.
          </li>
          <li>
            <span className="font-semibold">Values:</span> Transparency,
            accountability, inclusivity, and journalistic excellence.
          </li>
        </ul>
      </section>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        {[
          ...
          <div
            key={stat.label}
            className="bg-base-200 rounded-xl p-5 text-center shadow-sm"
          >
          ...
          {[
            {
              ...
              bio: "20+ years in print and digital journalism. Former BBC Bangla correspondent.",
            },
            {
              name: "Nusrat Jahan",
              role: "Head of Investigations",
              img: "https://i.pravatar.cc/150?img=47",
              bio: "Award-winning investigative reporter with a decade of field experience.",
            },
            {
              name: "Tanvir Hossain",
              role: "Technology & Digital Lead",
              img: "https://i.pravatar.cc/150?img=12",
              bio: "Leads the platform engineering and digital strategy for Dragon News.",
            },
          ].map((member) => (
            <div
              key={member.name}
              className="bg-base-100 shadow-md rounded-xl p-5 flex flex-col items-center text-center"
            >
              <img
                src={member.img}
                alt={member.name}
